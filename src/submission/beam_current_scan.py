from submission_mb import write_submission_script
import argparse
...
if __name__ == "__main__":
    ...
    if args.sub_mode == "ccrt":
        for i, I_b in enumerate(
            ...
            / 416
            * 1e-3
            * np.linspace(args.min_current, args.max_current, args.n_scan_points)
        ):
