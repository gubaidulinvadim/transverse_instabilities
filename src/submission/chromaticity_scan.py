...
if __name__ == "__main__":
    ...
    if args.sub_mode == "ccrt":
        for i, Qp_y in enumerate(
            np.linspace(
                args.min_chromaticity, args.max_chromaticity, args.n_scan_points
            )
        ):
            job = write_submission_script_ccrt(
                args.job_name + "".format(i),
                args.job_time,
