"""
Deprecated test scan script - use jobsmith instead.
...
warnings.warn(
    "test.py is deprecated. Please use jobsmith.submit_scan for parameter scans. "
...
def main():
    bunch_current = 1e-3 * np.linspace(0.2132, 12, 2)
    id_state = 'close'
    Zlong = ['True']
    hc = ['False']
    sc = ['True']
