...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="tmci_scan",
        help='Name of the job and associated .our and .err files. Defaults to "tmci_scan"',
    )
    parser.add_argument(
        "--job_time",
        action="store",
    ...
    if args.sub_mode == "ccrt":
        for i, I_b in enumerate(
            1e-3 * np.linspace(args.min_current, args.max_current, args.n_scan_points)
        ):
