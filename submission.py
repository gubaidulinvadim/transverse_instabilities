...
def write_submission_script_ccrt(job_name,
    ...
    with open(job_name, "w") as f:
        ...
        f.write(
            "pcocc run --mount {0:}  -I {1:} --entry-point -- python {2:} --n_macroparticles {3:} --n_turns {4:} --n_bin {5:} --bunch_current {6:} --Qp_x {7:} --Qp_y {8:} --ID_state {9:} --include_Zlong {10:} --harmonic_cavity {11:}\n".format(mount_folder,
                                                                                                                                                                                                                                                   IMAGE_NAME,
                                                                                                                                                                                                                                                   SCRIPT_NAME,
...
def write_submission_script_slurm(job_name,
    ...
    with open(job_name, "w") as f:
        ...
        f.write(
            "singularity exec --no-home --B {0:} {1:} python {2:} --n_macroparticles {3:} --n_turns {4:} --n_bin {5:} --bunch_current {6:} --Qp_x {7:} --Qp_y {8:} --ID_state {9:} --include_Zlong {10:} --harmonic_cavity {11:}\n".format(MOUNT_FOLDER,
                                                                                                                                                                                                                                           IMAGE_NAME,
                                                                                                                                                                                                                                           SCRIPT_NAME,
                                                                                                                                                                                                                                           n_macroparticles,
                                                                                                                                                                                                                                           n_turns,
